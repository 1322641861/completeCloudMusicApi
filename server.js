...
async function consturctServer(moduleDefs) {
   ...
   * @returns 
   */
  app.use("/login/openid", (req, res, next) => {
    let [appid, secret, js_code] = ["wxad277c118403377c", "691e85755aa3b9eb697861f6bf099c2d", req.query.code];
...
async function serveNcmApi(options) {
  const port = Number(options.port || process.env.PORT || '1319')
